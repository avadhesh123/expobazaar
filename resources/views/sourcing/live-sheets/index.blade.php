...
<div class="card">
    ...
    <div class="card-body" style="padding:0;overflow-x:auto;">
        <table class="data-table">
            <thead><tr><th>Live Sheet #</th><th>Offer Sheet</th><th>Vendor</th><th>Company</th><th>Items</th><th>CBM</th><th>Status</th><th>Consignment</th><th style="width:240px;">Next Action</th></tr></thead>
            <tbody>
                ...
                <tr style="{{ $ls->is_locked ? 'background:#f0fdf4;' : '' }}">
                    ...
                    <td><div style="font-size:.82rem;">{{ $ls->vendor->company_name ?? '—' }}</div><div style="font-size:.68rem;color:#94a3b8;">{{ $ls->vendor->vendor_code ?? '' }}</div></td>
                ...
                @empty
                <tr><td colspan="9" style="text-align:center;padding:3rem;color:#94a3b8;"><i class="fas fa-clipboard-list" style="font-size:2rem;display:block;margin-bottom:.5rem;"></i>No live sheets.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
