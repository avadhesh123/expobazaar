            ...
            <table class="data-table" style="min-width:3400px;font-size:.78rem;">
                <thead>
                    <tr style="background:#f0f4f8;">
                        ...
                        <th style="min-width:55px;">Product Length (inches)</th>
                        <th style="min-width:55px;">Product Width (inches)</th>
                        <th style="min-width:55px;">Product Height (inches)</th>
                        <th style="min-width:60px;">Product Weight (grams)</th>
                        ...
                        <th style="min-width:50px;">Qty In Inner Pack</th>
                        ...
                        <th style="min-width:55px;">Qty In Master Pack</th>
                        ...
                        <th style="min-width:65px;">Master Carton Wt(KG)</th>
