...
<form method="POST" action="{{ route('sourcing.live-sheets.update-sourcing', $liveSheet) }}" id="sourcingForm">
    ...
    <div style="margin-top:1rem;display:flex;gap:.5rem;justify-content:flex-end;">
        ...
        <button type="submit" class="btn btn-primary" onclick="return confirm('Save sourcing updates (Target FOB, Final Qty, Final FOB, Freight Factor, WSP Factor, Comments)?')"><i class="fas fa-save" style="margin-right:.3rem;"></i> Save Sourcing Updates</button>
    </div>
</form>
@endsection