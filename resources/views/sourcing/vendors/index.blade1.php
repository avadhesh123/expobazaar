...
<div class="card">
    ...
    <div class="card-body" style="padding:0;overflow-x:auto;">
        <table class="data-table">
            <thead><tr><th>Vendor</th><th>Company</th><th>Contact</th><th>Onboarding Progress</th><th>Status</th><th>Created</th></tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('sourcing.vendors.show', $vendor) }}" class="btn btn-outline btn-sm"><i class="fas fa-eye"></i> View</a></td>
                </tr>
                @empty
                <tr><td colspan="6" style="text-align:center;padding:3rem;color:#94a3b8;"><i class="fas fa-users" style="font-size:2rem;display:block;margin-bottom:.5rem;"></i>No vendors found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
