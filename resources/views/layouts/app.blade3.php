...
<body>
 ...
 <div class="logo" style="text-align:center;">
            <img src="{{ asset('images/logo.jpeg') }}" alt="ExpoBazaar" style="height: 100px;margin-bottom:.2rem;">
         </div>        @auth
            ...
            @elseif(auth()->user()->department === 'logistics')
                ...
                <a href="{{ route('logistics.container-planning') }}" class="{{ request()->routeIs('logistics.container*') ? 'active' : '' }}"><i class="fas fa-cubes"></i> Container Planning</a>
                <a href="{{ route('logistics.shipments') }}" class="{{ request()->routeIs('logistics.shipments*') ? 'active' : '' }}"><i class="fas fa-ship"></i> Shipments & ASN</a>
                <a href="{{ route('logistics.grn') }}" class="{{ request()->routeIs('logistics.grn*') ? 'active' : '' }}"><i class="fas fa-clipboard-check"></i> GRN</a>
                <div class="section-title">Inventory</div>
                <a href="{{ route('logistics.inventory') }}" class="{{ request()->routeIs('logistics.inventory') ? 'active' : '' }}"><i class="fas fa-boxes"></i> Stock</a>
                <a href="{{ route('logistics.inventory.ageing') }}" class="{{ request()->routeIs('logistics.inventory.ageing') ? 'active' : '' }}"><i class="fas fa-clock"></i> Ageing</a>
                <a href="{{ route('logistics.inventory.allocation') }}" class="{{ request()->routeIs('logistics.inventory.allocation') ? 'active' : '' }}"><i class="fas fa-warehouse"></i> Allocation</a>
                <div class="section-title">Charges</div>
                <a href="{{ route('logistics.warehouse-charges') }}" class="{{ request()->routeIs('logistics.warehouse*') ? 'active' : '' }}"><i class="fas fa-calculator"></i> Warehouse Charges</a>
                <a href="{{ route('logistics.rate-cards') }}" class="{{ request()->routeIs('logistics.rate*') ? 'active' : '' }}"><i class="fas fa-tags"></i> Rate Cards</a>
