...
<body>
    <aside class="sidebar">
        <div class="logo"><h1>Expo<span>Bazaar</span></h1><p style="color:#4a5e6f;font-size:.65rem;margin-top:.15rem;">Supply Chain Management</p></div>
        @auth
            ...
            @elseif(auth()->user()->isVendor())
                ...
                <a href="{{ route('vendor.offer-sheets') }}"><i class="fas fa-file-alt"></i> Offer Sheets</a>
                <a href="{{ route('vendor.consignments') }}"><i class="fas fa-box"></i> Consignments</a>
                <a href="{{ route('vendor.sales') }}"><i class="fas fa-chart-line"></i> Sales Report</a>
                <a href="{{ route('vendor.payouts') }}"><i class="fas fa-money-check-alt"></i> Payouts</a>
            ...
            @elseif(auth()->user()->department === 'logistics')
                ...
                <a href="{{ route('logistics.shipments') }}"><i class="fas fa-ship"></i> Shipments</a>
