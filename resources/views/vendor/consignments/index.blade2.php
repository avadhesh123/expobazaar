...
<div class="card">
    <div class="card-header">
        <h3><i class="fas fa-box" style="margin-right:.5rem;color:#2d6a4f;"></i> Consignments</h3>
    </div>
    <div class="card-body" style="padding:0;overflow-x:auto;">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr id="insp{{ $c->id }}" style="display:none;background:#eff6ff;">
                    <td colspan="8" style="padding:.75rem;">
                        <form method="POST" action="{{ route('vendor.inspections.upload', $c) }}" enctype="multipart/form-data" style="display:flex;flex-wrap:wrap;gap:.5rem;align-items:flex-end;">@csrf
                            <div><label style="font-size:.65rem;font-weight:600;color:#1e40af;">Type *</label><select name="inspection_type" required style="padding:.3rem .5rem;border:1px solid #bfdbfe;border-radius:6px;font-size:.82rem;font-family:inherit;">
                            ...
                            <div><label style="font-size:.65rem;font-weight:600;color:#1e40af;">Result</label><select name="result" style="padding:.3rem .5rem;border:1px solid #bfdbfe;border-radius:6px;font-size:.82rem;font-family:inherit;">
                            ...
                            <div><label style="font-size:.65rem;font-weight:600;color:#1e40af;">Commercial Invoice </label><input type="file" name="commercial_invoice" style="font-size:.78rem;"></div>
                            <div><label style="font-size:.65rem;font-weight:600;color:#1e40af;">Packing List </label><input type="file" name="packing_list" style="font-size:.78rem;"></div>
                ...
                @empty
                <tr>
                    <td colspan="8" style="text-align:center;padding:3rem;color:#94a3b8;"><i class="fas fa-box" style="font-size:2rem;display:block;margin-bottom:.5rem;"></i>No consignments yet.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
