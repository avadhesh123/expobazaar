...
<div style="display:flex;gap:.5rem;margin-bottom:1.25rem;">
    <a href="{{ route('vendor.live-sheets.edit', $liveSheet) }}" class="btn btn-outline btn-sm"><i class="fas fa-arrow-left"></i> Back to Live Sheet</a>
</div>
...
<div style="display:flex;gap:1rem;margin-bottom:1.25rem;">
    ...
    <div class="kpi-card" style="flex:1;border-left:3px solid #e8a838;"><div class="kpi-label">Sourcing Updates</div><div class="kpi-value" style="color:#e8a838;">{{ $changes->getCollection()->where('changed_by_role', 'sourcing')->count() }}</div></div>
    <div class="kpi-card" style="flex:1;border-left:3px solid #2d6a4f;"><div class="kpi-label">Vendor Updates</div><div class="kpi-value" style="color:#2d6a4f;">{{ $changes->getCollection()->where('changed_by_role', 'vendor')->count() }}</div></div>
</div>
