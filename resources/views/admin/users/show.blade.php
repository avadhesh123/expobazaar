...
<div style="display:flex;gap:.5rem;margin-bottom:1.25rem;">
    ...
    <a href="{{ route('admin.users.permissions', $user) }}" class="btn btn-sm" style="background:#ede9fe;color:#6d28d9;border:1px solid #c4b5fd;"><i class="fas fa-key"></i> Manage Permissions</a>
    @if($user->id !== auth()->id())
