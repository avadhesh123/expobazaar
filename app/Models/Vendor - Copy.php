...
class Vendor extends Model
{
    ...
    protected $fillable = [
        ...
        'bank_swift_code', 'kyc_status', 'kyc_submitted_at', 'kyc_approved_at',
    ...
    public function offerSheets() { return $this->hasMany(OfferSheet::class); }
    ...
    public function warehouseCharges() { return $this->hasMany(WarehouseCharge::class); }
    public function payouts() { return $this->hasMany(VendorPayout::class); }
    public function kycApprover() { return $this->belongsTo(User::class, 'kyc_approved_by'); }
    public function creator() { return $this->belongsTo(User::class, 'created_by'); }

    // Scopes
    public function scopeActive($query) { return $query->where('status', 'active'); }
    public function scopeByCompanyCode($query, $code) { return $query->where('company_code', $code); }
    public function scopePendingKyc($query) { return $query->where('kyc_status', 'submitted'); }
    public function scopePendingContract($query) { return $query->where('contract_status', 'sent'); }
    ...
    public function isContractSigned(): bool { return $this->contract_status === 'signed'; }
