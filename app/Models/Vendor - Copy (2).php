...
class Vendor extends Model
{
    ...
    protected $fillable = [
        ...
        'finance_contact_person', 'email', 'phone', 'landline', 'official_website',
        'address', 'street_address', 'city', 'state', 'province_state', 'country', 'pincode',
        'gst_number', 'iec_code', 'msme_number', 'pan_number',
