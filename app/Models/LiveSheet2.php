...
{
    protected $fillable = [
        'consignment_id', 'offer_sheet_id', 'vendor_id', 'company_code',
        'live_sheet_number', 'status', 'total_cbm',
        'is_locked', 'locked_by', 'locked_at', 'unlocked_by', 'unlocked_at',
        'approved_by', 'approved_at', 'remarks', 'ex_factory_date', 'final_inspection_date'
    ];
