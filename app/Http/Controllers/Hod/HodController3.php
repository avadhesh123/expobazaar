...
class HodController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        try {
            ...
            $data['pricing_stats'] = ['pending_preparation' => 0, 'submitted_to_finance' => 0, 'finance_approved' => 0, 'finalized' => 0, 'rejected' => 0];
        }
    ...
    {
        // Try loading with platformPricing, fallback to just shipment
        try {
    ...
    public function pricingStatus(Asn $asn)
    {
        ...
        $summary = [
            ...
            'avg_margin'       => $pricings->count() > 0 ? $pricings->avg('margin_percent') : 0,
    ...
    public function finalizePricing(Asn $asn)
    {
        try {
            ...
            // If platform_pricing table doesn't exist, allow finalize
        }
