        ...
        try {
            ...
            foreach ($headers as $col => $header) {
                if (str_contains($header, 'sno') || $header === 'sno') {
                    ...
                    $colMap['category'] = $col;
                } elseif (str_contains($header, 'fob') || str_contains($header, 'vendor_fob') || str_contains($header, 'vendor_fob_mumbai_')) {
           ...
           file_put_contents("products.csv.log", print_r($products, true));
        } catch (\Exception $e) {
